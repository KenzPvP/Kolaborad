                    ...
                    <table class="w-full text-left table-auto min-w-max text-gray-900 dark:text-gray-100">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white dark:bg-gray-800">
                                ...
                                <td class="border px-4 py-2 text-left">{{ $category->judul }}</td>
                                <td class="border px-4 py-2 text-center">
                                    <a class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-2" href="{{ route('category-edit', $category->id) }}">
                                        Edit
                                    </a>
