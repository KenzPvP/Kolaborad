<x-app-layout>
    ...
    <x-slot name="header">
        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            <x-nav-link :href="route('testimoni-list')" :active="request()->routeIs('testimoni-list')">
                {{ __('Testimoni') }}
            </x-nav-link>
            <x-nav-link :href="route('kasus-list')" :active="request()->routeIs('kasus-list')">
                {{ __('Studi Kasus') }}
            </x-nav-link>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white dark:bg-gray-800">
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <a class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-2" href="{{ route('client-testimoni-edit', $client->id) }}">
                                        Edit
                                    </a>
