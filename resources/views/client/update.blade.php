    ...
    <form method="POST" action="{{ route('client-update', $client->id) }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <x-text-input id="name" class="block mt-1 w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200" 
                          type="text" name="name" :value="old('name', $client->name )" />
        ...
        <div class="mb-4">
            ...
            <x-text-input id="company" class="block mt-1 w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200" 
                          type="text" name="company" :value="old('company', $client->company)" />
        ...
        <div class="mb-4">
            ...
            <textarea id="description" class="block mt-1 w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 
                      ...
                      name="description" rows="4">{{ old('description', $client->description) }}</textarea>
        ...
        <div class="mt-6">
            ...
            @if($client->image)
                <img src="{{ asset($client->image) }}" alt="Client Image" class="mt-2 rounded-md shadow-md" width="150">
            @else
