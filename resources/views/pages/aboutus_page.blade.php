                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-10 md:grid-cols-2 md:gap-x-8">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-2 text-base text-gray-500">
                                        Mengadakan pelatihan IT gratis bagi masyarakat kurang mampu, membantu mereka mendapatkan keterampilan di bidang teknologi.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-2 text-base text-gray-500">
                                        Kolaborad berpartisipasi dalam program penghijauan dan kampanye untuk pengurangan sampah elektronik.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-2 text-base text-gray-500">
                                        Memberikan konsultasi gratis kepada UMKM untuk membantu mereka mengadopsi teknologi digital dalam bisnis mereka.
                                    </p>
                                </div>
                            </div>
