...
<head>
    ...
    <link rel="icon" href="{{ asset('images/Logo_kolaborad.png') }}" type="image/png">
        ...
        <div class="relative h-screen bg-cover bg-center" style="background-image: url('images/about.jpg');">
            ...
            <div class="relative z-10 flex flex-col justify-center items-center h-full text-center text-white">
                ...
                <div class="mt-2 text-xl font-semibold">
                    ...
                    <span class="text-[#4993EB]">Tentang Kami</span>
                </div>
            </div>
        </div>
                ...
                <div class="flex flex-col justify-center gap-20">
                    ...
                    <div class="text-start">
                        <h2 class="text-2xl text-[#4993EB] font-semibold tracking-wide uppercase">Sejarah awal mula
                            Kolaborad</h2>
                        <p class="mt-4 text-xl text-gray-500">
                            Kolaborad lahir dari sebuah percakapan sederhana namun penuh makna, berawal dari sesi ngopi
                            bareng setelah pandemi Covid-19 usai. Para pendirinya, yang telah pensiun dari berbagai
                            perusahaan nasional dan multinasional, berkumpul dengan satu keinginan yang sama: berbagi
                            ilmu dan pengalaman yang telah diperoleh selama bertahun-tahun untuk kemajuan Indonesia.

                        </p>
                        <p class="mt-4 text-xl text-gray-500">
                            Pandemi menyadarkan kami akan pentingnya keberlanjutan bisnis, terutama bagi UMKM dan
                            startup yang sering kali menjadi tulang punggung ekonomi, namun tak jarang menghadapi
                            tantangan besar di awal perjalanan mereka. Kami melihat begitu banyak usaha kecil yang
                            berjuang untuk bertahan dan melewati "lembah kematian" — fase di mana banyak startup dan
                            UMKM tumbang sebelum mereka sempat berkembang. Para pelaku UMKM dan startup ini memiliki
                            potensi luar biasa, tetapi sering kali kekurangan bimbingan dan dukungan yang tepat dari
                            para ahli.


                        </p>
                        <p class="mt-4 text-xl text-gray-500">
                            Dari sinilah Kolaborad muncul, dengan misi besar: membantu UMKM dan startup di Indonesia
                            berkembang melalui pendekatan kolaborasi. Kami percaya bahwa keberhasilan tidak bisa dicapai
                            sendirian. Oleh karena itu, kami menggabungkan berbagai keahlian dari para Coach kami yang
                            berpengalaman di bidang Marketing, Sales, Finance, IT, dan banyak lagi. Dengan
                            berkolaborasi, kami dapat memberikan solusi yang benar-benar disesuaikan dengan kondisi dan
                            kebutuhan spesifik setiap bisnis yang kami bantu.


                        </p>
                        <p class="mt-4 text-xl text-gray-500">
                            Bagi kami, UMKM dan startup bukan hanya bisnis kecil, mereka adalah masa depan pertumbuhan
                            ekonomi Indonesia. Melalui Kolaborad, kami berkomitmen untuk memberikan dampak nyata dan
                            membantu mereka melampaui tantangan, tumbuh dengan percaya diri, dan menjadi pilar penting
            ...
            <div class="relative min-h-screen bg-no-repeat bg-cover bg-center p-20"
                ...
                <div class="flex flex-row items-center justify-between h-full">
                    ...
                    <div class="flex flex-col text-end w-full md:w-1/2 gap-5">
                        <h2 class="text-xl md:text-2xl text-white font-semibold tracking-wide uppercase">Nilai-Nilai
                            Utama
                        </h2>
                        <p class="text-sm md:text-xl text-white">
                            Prinsip dari Kolaborad sebagai perusahaan IT konsultan adalah untuk memberikan solusi
                            teknologi
                            yang
                            inovatif dan berorientasi pada kolaborasi. Kami percaya bahwa kolaborasi yang efektif antara
                            tim
                            internal dan klien merupakan kunci keberhasilan setiap proyek.
                        </p>
                    </div>
                </div>
                            ...
                            <div class="flex flex-row justify-center items-center self-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" viewBox="0 0 24 24">
                                    <g fill="none">
                                        ...
                                        <path stroke="#4993eb" stroke-width="2" d="M14.992 16a5.38 5.38 0 0 1-5.984 0" />
                                    </g>
                                </svg>
                            </div>
                            <div class="px-6 py-4">
