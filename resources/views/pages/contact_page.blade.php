            ...
            <div class="relative h-screen bg-cover bg-center" style="background-image: url('images/shakehand.jpg');">
                ...
                <div class="relative z-10 flex flex-col justify-center items-center h-full text-center text-white">
                    ...
                    <div class="mt-2 text-xl font-semibold">
                        ...
                        <span class="text-[#4993EB]">Hubungi kami</span>
                    </div>
                </div>
            </div>
                ...
                <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                    <div>
                        ...
                        <ul class="flex mt-12 space-x-4">
                            <li
                                class="bg-[#4993EB] hover:bg-[#3065BC]  h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                    ...
                    <div class="bg-gray-100 p-6 rounded-lg">
                        <p class="text-sm font-semibold text-gray-800">Hubungi melalui email</p>



                        <form class="mt-8 space-y-4">
                            <input type='text' placeholder='Name'
                                class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#4993EB]" />
                            <input type='email' placeholder='Email'
                                class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#4993EB]" />
                            <input type='text' placeholder='Subject'
                                class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#4993EB]" />
                            <textarea placeholder='Message' rows="6"
                                class="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#4993EB]"></textarea>
                            <button type='button'
                                class="text-white bg-[#4993EB] hover:bg-[#3065BC]  tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='#fff'
