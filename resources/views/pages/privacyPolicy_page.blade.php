...
<body>
    ...
    <div class="relative h-screen bg-cover bg-center" style="background-image: url('images/privacyPolicy.png');">
        ...
        <div class="relative z-10 flex flex-col justify-center items-center h-full text-center text-white">
            ...
            <div class="mt-2 text-xl font-semibold">
                ...
                <span class="text-[#4993EB]">Privacy policy</span>
            </div>
        </div>
    </div>
    <div class="bg-gray-100 p-32 bg-gradient-to-r from-[#4993EB] to-[#3065BC]">
        <div class="flex flex-col container mx-auto px-4 py-8 gap-10">
            <div class="flex flex-col gap-2">
                <h1 class="text-center text-3xl font-bold mb-4 text-white">Privacy Policy</h1>
