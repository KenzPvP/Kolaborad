        ...
        <div class="flex flex-col w-full py-20 bg-white">
            ...
            <div class="container p-2 md:p-20 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white shadow-lg p-6  ">
                    ...
                    <h3 class="text-lg text-center font-bold text-gray-700 mb-2">Marketing Strategy</h3>
                    <p class="text-center text-gray-600 mb-4"> Kami membantu klien dalam menyusun dan mengimplementasikan strategi pemasaran yang
                ...
                <div class="bg-white shadow-lg p-6  ">
                    <div class="flex justify-center items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 48 48"><g fill="none" stroke="#4993eb" stroke-linejoin="round" stroke-width="4"><path d="M41 14L24 4L7 14v20l17 10l17-10z"/><path stroke-linecap="round" d="M24 22v8m8-12v12m-16-4v4"/></g></svg>
                    </div>
                    <h3 class="text-lg text-center font-bold text-gray-700 mb-2">Sales B2B & B2C Development</h3>
                    <p class="text-center text-gray-600 mb-4"> Tim kami memberikan bimbingan dalam mengembangkan strategi penjualan yang optimal, baik
                ...
                <div class="bg-white shadow-lg p-6  ">
                    <div class="flex justify-center items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 16 16"><path fill="#4993eb" fill-rule="evenodd" d="M11.25 1a.75.75 0 0 1 .75.75V3h2a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h2V1.75a.75.75 0 0 1 1.5 0V3h5V1.75a.75.75 0 0 1 .75-.75M2.5 7.5v6h11v-6zm0-1.5h11V4.5h-11zm7.78 2.97a.75.75 0 0 1 0 1.06l-2.25 2.25a.75.75 0 0 1-1.06 0l-1.25-1.25a.75.75 0 1 1 1.06-1.06l.72.72l1.72-1.72a.75.75 0 0 1 1.06 0" clip-rule="evenodd"/></svg>
                    </div>
                    <h3 class="text-lg text-center font-bold text-gray-700 mb-2">Financial Planning & Management</h3>
                    <p class="text-center text-gray-600 mb-4"> Layanan kami mencakup manajemen keuangan yang kuat, termasuk pengelolaan cash flow,
                ...
                <div class="bg-white shadow-lg p-6  ">
                    ...
                    <h3 class="text-lg text-center font-bold text-gray-700 mb-2">Digital Transformation & IT Solutions</h3>
                    <p class="text-center text-gray-600 mb-4"> Kolaborad memberikan solusi digital yang terintegrasi untuk membantu bisnis bertransformasi
                ...
                <div class="bg-white shadow-lg p-6  ">
                    <div class="flex justify-center items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 24 24"><path fill="none" stroke="#4993eb" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m12 22l-2-6H2l2 6zm0 0h4m-4-9v-.5c0-1.886 0-2.828-.586-3.414S9.886 8.5 8 8.5s-2.828 0-3.414.586S4 10.614 4 12.5v.5m15 0a2 2 0 1 1-4 0a2 2 0 0 1 4 0m-9-9a2 2 0 1 1-4 0a2 2 0 0 1 4 0m4 13.5h6a2 2 0 0 1 2 2v.5a2 2 0 0 1-2 2h-1" color="#4993eb"/></svg>
                    </div>
                    <h3 class="text-lg text-center font-bold text-gray-700 mb-2">Coaching dan Mentoring</h3>
                    <p class="text-center text-gray-600 mb-4">Kami memiliki jaringan coach dan mentor yang berpengalaman di berbagai bidang seperti
                ...
                <div class="bg-white shadow-lg p-6  ">
                    <div class="flex justify-center items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 24 24"><g fill="none" stroke="#4993eb" stroke-width="1.5"><path d="M17.414 10.414C18 9.828 18 8.886 18 7s0-2.828-.586-3.414m0 6.828C16.828 11 15.886 11 14 11h-4c-1.886 0-2.828 0-3.414-.586m10.828 0Zm0-6.828C16.828 3 15.886 3 14 3h-4c-1.886 0-2.828 0-3.414.586m10.828 0Zm-10.828 0C6 4.172 6 5.114 6 7s0 2.828.586 3.414m0-6.828Zm0 6.828ZM13 7a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z"/><path stroke-linecap="round" d="M18 6a3 3 0 0 1-3-3m3 5a3 3 0 0 0-3 3M6 6a3 3 0 0 0 3-3M6 8a3 3 0 0 1 3 3m-4 9.388h2.26c1.01 0 2.033.106 3.016.308a14.9 14.9 0 0 0 5.33.118c.868-.14 1.72-.355 2.492-.727c.696-.337 1.549-.81 2.122-1.341c.572-.53 1.168-1.397 1.59-2.075c.364-.582.188-1.295-.386-1.728a1.89 1.89 0 0 0-2.22 0l-1.807 1.365c-.7.53-1.465 1.017-2.376 1.162q-.165.026-.345.047m0 0l-.11.012m.11-.012a1 1 0 0 0 .427-.24a1.49 1.49 0 0 0 .126-2.134a1.9 1.9 0 0 0-.45-.367c-2.797-1.669-7.15-.398-9.779 1.467m9.676 1.274a.5.5 0 0 1-.11.012m0 0a9.3 9.3 0 0 1-1.814.004"/><rect width="3" height="8" x="2" y="14" rx="1.5"/></g></svg>
                    </div>
                    <h3 class="text-lg text-center font-bold text-gray-700 mb-2">Business Process Improvement</h3>
                    <p class="text-center text-gray-600 mb-4"> Kami mengidentifikasi dan memperbaiki proses bisnis klien untuk meningkatkan
                ...
                <div class="bg-white shadow-lg p-6  ">
                    <div class="flex justify-center items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 24 24"><g fill="none" stroke="#4993eb" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="#4993eb"><path d="M3 14v-4c0-3.771 0-5.657 1.172-6.828S7.229 2 11 2h2c3.771 0 5.657 0 6.828 1.172S21 6.229 21 10v4c0 3.771 0 5.657-1.172 6.828S16.771 22 13 22h-2c-3.771 0-5.657 0-6.828-1.172S3 17.771 3 14"/><path d="M11.333 10.667c1.055 1.055 2.445 2.127 2.445 2.127l1.904-1.905s-1.072-1.39-2.126-2.445C12.5 7.39 11.11 6.317 11.11 6.317L9.206 8.222s1.072 1.39 2.127 2.445m0 0L8 14m8-3.429l-2.54 2.54M11.43 6L8.89 8.54M8 18h8"/></g></svg>
                    </div>
                    <h3 class="text-lg text-center font-bold text-gray-700 mb-2">Pengurusan Legalitas Perusahaan dan HAKI</h3>
                    <p class="text-center text-gray-600 mb-4"> Kami juga menawarkan jasa pengurusan legalitas bisnis serta pengurusan Hak
                ...
                <div class="bg-white shadow-lg p-6">
                    <div class="flex justify-center items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 24 24"><path fill="#4993eb" d="m17.95 19.464l-2.138-2.114l.713-.708l1.425 1.42l3.525-3.525l.713.688zM7 20v-4H3.577V8.616h16.846v2.807q-.31-.1-.643-.165q-.334-.066-.667-.066q-1.7 0-3.114.88q-1.415.878-2.172 2.39H8V19h5.466q.078.28.203.521q.125.24.264.479zM7 7.846v-3.23h10v3.23z"/></svg>
                    </div>
                    <h3 class="text-lg text-center font-bold text-gray-700 mb-2">Koneksi dengan Venture Capital (VC)</h3>
                    <p class="text-center text-gray-600 mb-4"> Kolaborad membantu startup yang sedang mencari pendanaan dengan
